...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['id'])){
      ...
      if(empty($data_missing)){
        ...
        $query = "DELETE FROM fundraiser where id=?";
        ...
        if($affected_rows == 1){
					...
					echo "<div class='form'>
<h3>You have deleted the event successfully.</h3>
...
<font color="black">
<div class='form'>
<b><h1><center>***DELETING FUNDRAISER ENTRY***</center></h1></b>

<form name="registration" action="" method="post">
  <div>
<label>Fundraiser's ID:</label><input type="text" name="id" required /><br><br>
